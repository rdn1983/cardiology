...
namespace Cardiology
{
    public partial class AmbulanceLetters : Form
    {
        ...
        private void gbUdinaBtn_Click(object sender, System.EventArgs e)
        {
            ...
            TemplatesUtils.fillAmbulanceLetterTemplate("gkb_yudina_letter_template.docx", hospitalitySession.ObjectId, data);
        }
        ...
        private void gkbBuyanovaBtn_Click(object sender, System.EventArgs e)
        {
            ...
            DdtDoctors doc = (DdtDoctors)doctorsBox.SelectedItem;
            data.Add("{doctor.selected}", doc == null ? "" : doc.DssInitials);
            TemplatesUtils.fillAmbulanceLetterTemplate("gkb_buyanova_letter_template.docx", hospitalitySession.ObjectId, data);
        }
        ...
        private void lrcBtn_Click(object sender, System.EventArgs e)
        {
            ...
            DdtDoctors doc = (DdtDoctors)doctorsBox.SelectedItem;
            data.Add("{doctor.selected}", doc == null ? "" : doc.DssInitials);
            TemplatesUtils.fillAmbulanceLetterTemplate("lrc_letter_template.docx", hospitalitySession.ObjectId, data);
        }
        ...
        private void button4_Click(object sender, System.EventArgs e)
        {
            ...
            DdtDoctors doc = (DdtDoctors)doctorsBox.SelectedItem;
            data.Add("{doctor.selected}", doc == null ? "" : doc.DssInitials);
            TemplatesUtils.fillAmbulanceLetterTemplate("gkb83_letter_template.docx", hospitalitySession.ObjectId, data);
        }
        ...
        private void mschBtn_Click(object sender, System.EventArgs e)
        {
            ...
            DdtDoctors doc = (DdtDoctors)doctorsBox.SelectedItem;
            data.Add("{doctor.selected}", doc == null ? "" : doc.DssInitials);
            TemplatesUtils.fillAmbulanceLetterTemplate("msch60_letter_template.docx", hospitalitySession.ObjectId, data);
        }
        ...
        private void gkb52Btn_Click(object sender, System.EventArgs e)
        {
            ...
            DdtDoctors doc = (DdtDoctors)doctorsBox.SelectedItem;
            data.Add("{doctor.selected}", doc == null ? "" : doc.DssInitials);
            TemplatesUtils.fillAmbulanceLetterTemplate("gkb52_letter_template.docx", hospitalitySession.ObjectId, data);
        }
    }
}
