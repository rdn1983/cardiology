...
CREATE OR REPLACE FUNCTION audit_ddt_urine_analysis_creating_row () RETURNS TRIGGER AS '
BEGIN
...
CREATE TRIGGER audit_ddt_urine_analysis AFTER INSERT 
	ON ddt_urine_analysis FOR EACH ROW 
EXECUTE PROCEDURE audit_ddt_urine_analysis_creating_row();