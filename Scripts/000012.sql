...
CREATE OR REPLACE FUNCTION audit_ddt_uzi_creating_row () RETURNS TRIGGER AS '
BEGIN
...
CREATE TRIGGER audit_ddt_uzi AFTER INSERT 
	ON ddt_uzi FOR EACH ROW 
EXECUTE PROCEDURE audit_ddt_uzi_creating_row();
