...
CREATE OR REPLACE FUNCTION audit_ddt_kag_creating_row () RETURNS TRIGGER AS '
BEGIN
...
CREATE TRIGGER audit_ddt_kag AFTER INSERT 
	ON ddt_kag FOR EACH ROW 
EXECUTE PROCEDURE audit_ddt_kag_creating_row();