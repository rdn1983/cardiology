...
namespace Cardiology.UI.Forms
{
    public partial class Consilium : Form, IAutoSaveForm
    {
        ...
        private void kagBtn_CheckedChanged(object sender, EventArgs e)
        {
            ...
            goalTxt.Text = "Определить показания к оперативному пособию";
        }
        ...
        private void tranfusionBnt_CheckedChanged(object sender, EventArgs e)
        {
            decisionTxt.Text = "Пациент нуждается в переливании эритроцитной взвеси с целью коррекции гемической гипоксии, восполнения дефицита форменных элементов крови.";
            goalTxt.Text = "Определить показания к переливанию крови";
        }
