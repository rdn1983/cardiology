...
INSERT INTO ddt_values (dss_name, dss_value) VALUES ('death.medicine.0', 'Sol. Dopamini 200мг + Sol. NaCl 0,9%– 500ml  V = 60 мл/ч');
...
INSERT INTO ddt_values (dss_name, dss_value) VALUES ('justificationTxt.dt', 'Учитывая диагноз, сопутствующую патологию, пациенту показана ноотропная, антикоагулянтная, диуретическая, ритмоурежеющая, гастропротективная терапия. настоящая терапия обоснована и соответствует стандартам лечения дисциркуляторным нарушениям, нарушениям ритма и проводимости, а также гипертонической болезни.');